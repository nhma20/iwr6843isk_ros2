...
def main(argv=None):
    ...
    cfg_path = os.path.dirname(os.path.realpath(__file__)).replace("install/iwr6843isk_pub/lib/python3.8/site-packages/iwr6843isk_pub", "/src/iwr6843isk_pub/cfg_files") + "/" + "xwr68xx_profile_30Hz.cfg"
